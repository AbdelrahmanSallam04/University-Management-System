    ...
    public class EquipmentController {
        ...
        public ResponseEntity<List<StaffMember>> searchFaculty(
            ...
            List<StaffMember> faculty = equipmentService.searchFaculty(name);
        ...
        public ResponseEntity<List<Student>> searchStudents(
                @RequestParam(required = false) String name) {
            List<Student> students = equipmentService.searchStudents(name);
            return ResponseEntity.ok(students);
        }

        @GetMapping("/attributes")
        public ResponseEntity<List<EquipmentAttributes>> getAllAttributes() {
