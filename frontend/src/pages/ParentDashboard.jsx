...
const getGradeColor = (marks) => {
  if (marks.totalMarks >= 90) return 'excellent';
  if (marks.totalMarks >= 80) return 'good';
  if (marks.totalMarks >= 70) return 'average';
  if (marks.totalMarks >= 60) return 'below-average';
  return 'poor';
};
